<main>
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <a class="carousel-item active" href="../app/views/catalogues.html">
                ...
                <div class="carousel-item">
                    <a class="lien " href="../app/views/catalogues.html">
                ...
                <div class="carousel-item">
                    <a class="lien" href="../app/views/catalogues.html">
                        ...
                        <div class="container">
                            <div class="new ">
                            <img src="../app/public/img/new.png" width="200px" height="200px"/>
                            </div>
